...
export default function ExcelColumnRemover() {
  ...
  // Handle yellow columns selection using modular function
  const handleSelectYellowColumns = () => {
    const newSelection = selectYellowColumns(headers, selectedHeaders);
